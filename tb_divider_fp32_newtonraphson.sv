`timescale 1ns / 1ps
/*
    tb_divider_fp32_newtonraphson.sv
    Self-checking testbench for divider_fp32_newtonraphson.sv.
    ±2 ULP tolerance for iterative method (per handoff spec).
    Brendan Lynskey 2025
*/

module tb_divider_fp32_newtonraphson;

`include "tb_fp32_tasks.sv"

localparam TB_RANDOM_CNT  = 500;
localparam TIMEOUT_CYCLES = 64;
localparam ULP_TOL        = 2;   // iterative methods: ±2 ULP
...
divider_fp32_newtonraphson u_dut (
