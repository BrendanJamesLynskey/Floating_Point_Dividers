`timescale 1ns / 1ps
/*
    tb_divider_fp32_goldschmidt.sv
    Self-checking testbench for divider_fp32_goldschmidt.sv.
    ±2 ULP tolerance for iterative method.
    Brendan Lynskey 2025
*/

module tb_divider_fp32_goldschmidt;

`include "tb_fp32_tasks.sv"

localparam TB_RANDOM_CNT  = 500;
localparam TIMEOUT_CYCLES = 64;
localparam ULP_TOL        = 2;
...
divider_fp32_goldschmidt u_dut (
